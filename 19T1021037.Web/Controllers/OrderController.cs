...
namespace _19T1021037.Web.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        private const string NO_PER = "Không có quyền thực hiện thao tác này";
        ...
        public ActionResult Index()
        {
            ...
            Models.OrderSearchInput condition = Session[SHOPPING_CART] as Models.OrderSearchInput;
            if(condition == null)
            {
        ...
        {
            int rowCount = 0;
            var data = OrderService.ListOfOrders(condition.Page, condition.PageSize, condition.Status, condition.SearchValue, out rowCount);
        ...
        public ActionResult Details(int id = 0)
        {
            ...
            var orderDetail = new Models.OrderDetailModel()
            {
                Data = data,
        ...
        public string UpdateDetail(OrderDetail data)
        {
            ...
            var employeeAccount = Converter.CookieToUserAccount(User.Identity.Name).UserID;
            if (Convert.ToInt32(employeeAccount) == order.EmployeeID && order.Status == 1)
            {
        ...
        public ActionResult Delete(int id = 0)
        {
            ...
            var employeeAccount = Converter.CookieToUserAccount(User.Identity.Name).UserID;
            if (Convert.ToInt32(employeeAccount) != order.EmployeeID)
            {
                TempData[ERROR_MESSAGE] = NO_PER;
        ...
        {
            int rowCount = 0;
            var data = ProductDataService.ListOfProducts(page, PAGE_SIZE, searchValue, 0, 0, out rowCount);
            ViewBag.Page = page;
            return View(data);
        }
        /// <summary>
