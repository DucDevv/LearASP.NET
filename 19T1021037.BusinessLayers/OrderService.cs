...
namespace _19T1021037.BusinessLayers
{
    ...
    public static class OrderService
    {
        ...
        /// <summary>
        /// Lấy thông tin đơn hàng đưa vào mã
        /// </summary>
        ...
        public static bool CancelOrder(int orderID)
        {
            ...
            // Có thể huỷ bỏ đơn hàng khi đơn hàng vừa tạo hoặc đơn hàng bị từ chối
            //... Your code here ...
        ...
        public static bool RejectOrder(int orderID)
        {
            ...
            // Có thể từ chối đơn hàng khi đơn hàng bị huỷ hoặc đơn hàng bị từ chối
            //... Your code here ...

            if (data.Status == OrderStatus.CANCEL || data.Status == OrderStatus.REJECTED)
        ...
        public static bool AcceptOrder(int orderID)
        {
            ...
            // Hợp lý khi đơn hàng đã được duyệt
            //... Your code here ...
        ...
        /// (chỉ cho phép xóa đơn hàng đang ở một trong số các trạng thái: vừa khởi tạo, bị hủy hoặc bị từ chối) (1, -1, -2)
        /// </summary>
        /// <param name="orderID"></param>
        /// <returns></returns>
